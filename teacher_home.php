<?php
	...
	{
		echo"<script>window.open('teacher_login.php?mes=Access not granted','_self');</script>";
				...
				<div class="content">
					...
					<?php
						if(isset($_POST["submit"]))
						{
							...
							$sql="update staff set PNO='{$_POST["pno"]}',MAIL='{$_POST["mail"]}',PADDR='{$_POST["addr"]}'";
							$db->query($sql);
